...
const MESSAGING_COMPLEXITY_QUESTIONS = {
  Light: [
    ...
    'messaging_primary_target_audiences','messaging_sharp_messaging_themes','messaging_headline_options','messaging_NET_payments','messaging_expiration_date',
  ],
  Medium: [
    'client_materials','competitors_analyze','messaging_strategy_session','messaging_review_rounds',
    ...
    'messaging_hour_worksession_with_internal_teams','messaging_core_messages_aligned','messaging_clear_behavioral_commitments','messaging_NET_payments','messaging_expiration_date',
  ],
  Large: [
    'client_materials','competitors_analyze','messaging_strategy_session','messaging_review_rounds',
